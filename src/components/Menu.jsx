    ...
    return (
        <>
            <button
             ...
             className="z-20 fixed top-12 right-12 p-3 bg-green-500 w-11 h-11 rounded-md">
                <div
            ...
            <div
                className={`z-10 fixed top-0 right-0 bottom-0 bg-white tranition-all overflow-hidden flex flex-col ${menuOpened ? "w-80" : "w-0"}`}
            >
...
const MenuButton = (props) => {
    ...
    return (
        <button
            onClick={onClick}
            className="text-2xl font-bold cursos-pointer hover:text-green-500 transition-colors"
        >
            {label}
        </button>
    )
